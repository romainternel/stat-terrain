...
| Layout Match iPhone | STORY-02/03 (non livrées) | Écran Match utilisable sans chevauchement sur iPhone | Critique | ❌ Connu cassé actuellement — voir `docs/design/screenshots/04-match-iphone-portrait.png` et `05-match-iphone-landscape.png`. Ne pas cocher tant que STORY-02/03 ne sont pas livrées. |
